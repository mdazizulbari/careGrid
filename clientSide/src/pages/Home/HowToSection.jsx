...
const HowToSection = () => {
  return (
    <div className="flex max-w-3xl flex-col items-center justify-center gap-10 px-5">
      <h2 className="text-primary font-gummy text-center text-4xl font-bold md:text-5xl">
        How To Participate in Camps
      </h2>
      ...
      <div className="join join-vertical bg-base-100">
        ...
        <div className="collapse-arrow join-item border-base-300 collapse border">
          ...
          <div className="collapse-content text-sm">
            ...
            location, or fees. This makes it easy to find camps that match your
            schedule and budget.
          </div>
        </div>
        <div className="collapse-arrow join-item border-base-300 collapse border">
